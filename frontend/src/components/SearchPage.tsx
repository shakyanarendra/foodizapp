                  ...
                  >
                      ...
                      <div className="flex gap-2 mt-4 flex-wrap">
                        {restaurant.cuisines.map(
                          (cuisine: string, idx: number) => (
                            <Badge
                              key={idx}
                              className="font-medium text-white dark:bg-gray-100 hover:dark:bg-gray-200 dark:text-black hover:bg-gray-800  px-2 py-1 rounded-full shadow-sm"
                            >
                              {cuisine}
                            </Badge>
                          )
                    ...
                    <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                      <Link to={`/restaurant/${restaurant._id}`}>
                        <Button className="text-white dark:bg-gray-100 hover:dark:bg-gray-200 dark:text-black  font-semibold py-2 px-4 rounded-full shadow-md transition-colors duration-200">
                          View Menus
                        </Button>
                      </Link>
                    </CardFooter>
...
const NoResultFound = ({ searchText }: { searchText: string }) => {
  return (
    <div className="text-center">
      ...
      <Link to="/">
        <Button className="mt-4 text-white dark:bg-gray-100 hover:dark:bg-gray-200 dark:text-black hover:bg-orangeHover">
          Go Back to Home
        </Button>
      </Link>
    </div>
